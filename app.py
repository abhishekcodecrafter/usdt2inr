...
app.route('/usdtidthdrawl')(usdtwidthdrawl)
app.route('/rh')(rh)
app.route('/usdtdeposit')(usdtdeposit)
app.route('/usdtdepositinfo')(usdtdepositinfo)
app.route('/usdtwidthdrawl')(usdtwidthdrawl)
app.route('/fullprofile')(fullprofile)
